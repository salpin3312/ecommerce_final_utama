                           ...
                           <div className="card-body">
                              ...
                              <div className="flex justify-between">
                                 ...
                                 <div className="text-right">
                                    ...
                                    <p className="font-bold">{formatCurrency(order.totalPrice.toLocaleString())}</p>
                                 </div>
                              </div>

                              <div className="card-actions justify-end mt-4">
                                 {order.status === "Menunggu_Konfirmasi" && (
                                    <button className="btn btn-error btn-outline">Batalkan</button>
                                 )}
                        ...
                        <tbody>
                           {completedOrders.map((order) => (
                              <tr key={order.id}>
                                 ...
                                 <td>{order.orderItems[0]?.quantity || 0}</td>
