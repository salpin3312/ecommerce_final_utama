...
function ProductDetail() {
   ...
   return (
      <div className="container mx-auto px-4 py-8">
         <Link to="/shop" className="btn btn-ghost mb-4">
            <ArrowLeft size={16} /> Back to Products
         </Link>
         ...
         <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
               {product.imageUrl ? (
                  <img
                     ...
                     onError={(e) => {
                        e.target.src = `https://placehold.co/600x400?text=${product.name.charAt(0)}`;
                     }}
                  />
               ) : (
                  <div className="w-full h-96 bg-gray-200 flex items-center justify-center rounded-lg">
                     <span className="text-gray-500 text-5xl">{product.name.charAt(0)}</span>
                  </div>
               )}
            </div>
            ...
            <div className="md:w-1/2">
               ...
               <div className="mb-6">
                  ...
                  <div className="join">
                     <button className="btn join-item" onClick={() => updateQuantity(quantity - 1)}>
                        -
                     </button>
                     <input
                        type="text"
               ...
               <button className="btn btn-primary btn-block" onClick={handleAddToCart} disabled={addingToCart}>
                  {addingToCart ? (
