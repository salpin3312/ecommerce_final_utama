...
import { User, Mail, Phone, MapPin, Calendar, Edit2, Save, X, Camera, Lock, Eye, EyeOff } from "lucide-react";
import { getUserProfile, updateUserProfile, changeUserPassword, uploadUserAvatar } from "../service/api/userService";
...
function Profile() {
   ...
   const handlePasswordUpdate = async () => {
      ...
      try {
         ...
         toast.success(response.message || "Password berhasil diubah! Silakan login ulang.");
         // Logout otomatis setelah ganti password
         await logout();
         setTimeout(() => {
            navigate("/login", { state: { message: "Password berhasil diubah! Silakan login ulang." } });
         }, 1000);
      } catch (error) {
   ...
   const handleAvatarChange = async (e) => {
      ...
      if (file) {
         ...
         try {
            ...
            toast.error(error.response?.data?.message || error.message || "Gagal upload avatar");
         } finally {
            setLoading(false);
         }
      }
      ...
      return (
         <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-gray-50 to-zinc-100 flex items-center justify-center">
            <div className="text-center">
               ...
               <p className="text-gray-600 mb-6">Silakan login terlebih dahulu untuk mengakses halaman profile.</p>
               <a
                  href="/login"
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-gray-50 to-zinc-100">
         <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-12">
               <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Profile Saya</h1>
               <p className="text-lg text-gray-600">Kelola informasi personal Anda</p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
                  ...
                  <div className="p-8">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                           <h3 className="text-xl font-bold text-gray-800 mb-4">Informasi Personal</h3>
               ...
               <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-6">
                     <h3 className="text-xl font-bold text-gray-800 mb-4">Keamanan Akun</h3>
